...
Latex is a uniquely powerful typesetting system, but I would rather not worry about latex code when trying to write documents. The slightly more simple org syntax with the ability to embed latex fragments where required is a much better system.
